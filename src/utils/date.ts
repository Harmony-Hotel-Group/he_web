 ...
 */
export function formatDateRange(start: Date, end: Date, nightsLabel: string): string {
 ...
 */
export function nightsLabel(nights: number, t?: (key: string, params?: Record<string, unknown>) => string): string {
	if (t) {
