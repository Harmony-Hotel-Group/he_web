...
class DatePickerSyncManager {
     ...
     */
    public register(pickerId: string, pickerInstance: any, syncGroup: string = 'default') {
        ...
        if (import.meta.env.DEV) {
            console.log(`[DatePickerSync] Registered: ${pickerId} in group: ${syncGroup}`);
        }
    }
     ...
     */
    public sync(sourceId: string, value: string, dates: Date[], syncGroup: string = 'default') {
