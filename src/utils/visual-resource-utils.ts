        ...
        if (import.meta.env.DEV) {
            try {
                ...
                const result = {
                    ...
                    error: isValid ? undefined : `Archivo local no encontrado: ${response.status}`,
                };
                ...
                const errorMessage = error instanceof Error ? error.message : 'Archivo local no accesible';
                const result = {
                    isValid: false,
                    finalSrc: undefined,
                    error: errorMessage,
...
if (import.meta.env.DEV) {
    if (typeof window !== 'undefined') {
        ...
        console.log('[VisualResource] Dev utils available at window.__visualResourceUtils');
    }
}