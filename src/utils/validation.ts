...
export const bookingFormSchema = z.object({
	...
	adults: z.string().min(1, "Selecciona al menos 1 adulto"),

	children: z.string().default("0"),

	rooms: z.string().min(1, "Selecciona al menos 1 habitación"),

	breakfast: z.string().default("true"),

	vehicle: z.string().default("false"),

	special_request: z.string().default("false"),
...
// Tipos inferidos
export type ContactFormData = typeof contactFormSchema._output;
export type BookingFormData = typeof bookingFormSchema._output;
export type VehicleFormData = typeof vehicleFormSchema._output;
 ...
 */
export async function validateFormData<T extends ReturnType<typeof z.object>>(
	schema: T,
